...
SECRET_KEY = 'm@b5akg$9_fbn9_2gd_0!57+(x+ag-fwi3@pn*m$jjh5-6mmeu'
...
BUDGET_SECRET_TOKEN = os.getenv('BUDGET_SECRET_TOKEN')
BUDGET_SLACK_TOKEN = os.getenv('BUDGET_SLACK_TOKEN')
